...
public class CalculatorDestroyerTwo {
	...
	private double doubResultActualLast = 0.0;
	private Random rand ;
...
//			public double getResult(double result,int number, int operator)
			...
			System.out.println("Actual : "+doubResultActual);
			System.out.println("Expect : "+doubResultExpected);
		}
		calcDestroyer.doEqualz();
		doubResultActualLast = calcDestroyer.getTxtResult();
		System.out.println("ACTUALLAST : "+doubResultActualLast);
		System.out.println("=========================================");
		System.out.println("ACTUAL : "+doubResultActual+" --- EXPECTED : "+doubResultExpected);
		System.out.println("ACTUALLAST : "+doubResultActualLast+" --- EXPECTED : "+doubResultExpected);
		assertEquals(doubResultActual, doubResultExpected);
		assertEquals(doubResultActualLast, doubResultExpected);
		calcDestroyer.clear();
	}
}